...
var getConfig = module.exports = function () {
  return {
    ...
    secret: process.env.SESSION_SECRET || 'mZOYlU4XdG89cEJmuExvkXNH',
    ...
    gcloud: {
      projectId: process.env.GCLOUD_PROJECT || 'gif-roulette'
    },

    // Typically you will create a bucket with the same name as your project ID.
    cloudStorageBucket: process.env.CLOUD_BUCKET || 'gif-roulette',
    ...
    oauth2: {
      clientId: process.env.OAUTH_CLIENT_ID || '722928377724-de5jcsf1464d7hf57g974ptb5so0hl7v.apps.googleusercontent.com',
      clientSecret: process.env.OAUTH_CLIENT_SECRET || 'mZOYlU4XdG89cEJmuExvkXNH',
